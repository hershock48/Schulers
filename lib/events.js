...
export const events = [
  {
    ...
    blurb:
      /* No founding year and no founder: the 1957/Women's Guild account and the
       Historical Society's own "61st Annual" numbering contradict each other,
       so the research verdict was to print neither. The 61st is theirs. */
      "The 61st Home Tour brings a few thousand people into town, and the kitchen runs a tour menu with courses named after the houses on it.",
  ...
  },
  {
    ...
    blurb:
      "Dinner service in the dining room, and the pub open after. The family has done this a hundred and seventeen times.",
    cta: { label: "Book a table", href: "/reservations" },
    placeholder: true,
  },
];
