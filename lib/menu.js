...
export const menu = [
  {
    ...
    items: [
      ...
      { id: "cheese-spread", name: "Heritage Cheese Spread Platter", desc: "House-made crackers, celery, carrots, and fresh bread.", price: 16, carryout: { price: 7, unit: "8 oz" }, orderable: true },
